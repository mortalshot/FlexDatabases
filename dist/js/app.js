(() => {
    ...
    function initSliders() {
        if (document.querySelector(".widget-blog__slider")) new core(".widget-blog__slider", {
            modules: [ Lazy ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.1,
        ...
        if (document.querySelector(".partners__slider")) {
            ...
            function partnersHandleMd2Change(e) {
                if (e.matches) parnersSlider = new core(".partners__slider", {
                    modules: [ Lazy ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 2.4,
        ...
        if (document.querySelector(".product-function__slider")) new core(".product-function__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
